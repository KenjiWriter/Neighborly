        ...
        return [
            ...
            'auth' => [
                ...
                'can' => [
                    ...
                    'viewFinanceOverview' => $request->user() && ($request->user()->hasRole(['admin', 'board_member', 'accountant', 'resident'])),
                    'viewFinanceEntries' => $request->user() && $request->user()->can('viewAny', \App\Models\FinanceEntry::class),
